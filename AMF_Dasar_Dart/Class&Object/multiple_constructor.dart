void main() {
  ...
  RekeningBank rekeningSastra =
      new RekeningBank.Sastra(namaPemilik: 'Bank BCA', saldo: 50000000);
  print(rekeningSastra.getBank);
}
...
class RekeningBank {
  ...
  RekeningBank.Sastra(
      {this.namaPemilik, this.namaBank = 'Sastra', this.saldo = 0});
